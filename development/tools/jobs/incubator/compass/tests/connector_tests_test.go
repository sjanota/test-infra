...
const connectorTestsJobPath = "./../../../../../prow/jobs/incubator/compass/connector-tests.yaml"
...
func TestConnectorTestsJobPresubmit(t *testing.T) {
	...
	actualPre := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-incubator/compass"], "pre-master-compass-tests-connector-tests", "master")
