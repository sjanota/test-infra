...
func TestProwAddonsCtrlManagerJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-project/test-infra"], "pre-master-test-infra-development-prow-addons-ctrl-manager", "master")
